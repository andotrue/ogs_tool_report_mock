...
@section('content')
        ...
        <table id="table_id" class="table table-striped table-bordered table-hover">
          ...
          @foreach($users as $user)
            <tr>
              ...
              <!--
              <td class="text-right">
                <a class="btn btn-xs btn-primary" href="{{ route('user.show', $user->id) }}"><i
                    class="glyphicon glyphicon-eye-open"></i></a>
                <a class="btn btn-xs btn-warning" href="{{ route('user.edit', $user->id) }}"><i
  ...
  <style>.mailadddress_line {
      display: inline;
    }</style>
  <style>#bnt-mailaddress-del {
      padding: 1px 12px;
      margin-left: 50px;
    }</style>
  <div>
  ...
  <div class="modal fade" id="testmailaddressModal" tabindex="-1" role="dialog"
       aria-labelledby="testmailaddressModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id='mailaddress-reg' action='/tool/user/testmailaddress_add' method='POST' class=''
                name='testmailaddress'>
            {{ csrf_field() }}
              ...
              <ul id="emaillist" class="list-group">
                ...
                <li class="list-group-item mailadddress_line<?php echo $id; ?>"
                  ...
                  <div class="mailadddress_line">
                    <a class="btn btn-danger" id="bnt-mailaddress-del"
                       onClick="return mailaddress_del(<?php echo $id; ?>);">削除</a>
                  </div>
                </li>
                <?php endforeach; ?>
              </ul>
